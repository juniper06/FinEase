  ...
  return (
    <table className="my-4 bg-cornsilk-500 rounded-lg">
      <thead className="border-4 border-black">
        <tr>
          <th className="border-black p-2">ID</th>
          <th className="border-black md:w-[600px]">Title</th>
      ...
      <tbody>
        {budgetProposals.map(proposal => (
          <tr key={proposal.id} className="border-b-4 border-black md:text-white">
            <td className="text-center border-l-4 border-black">{proposal.id}</td>
            <td className="text-center border-black">{proposal.title}</td>
